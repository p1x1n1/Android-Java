...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //object for create and mange db
    ...
    public void onClick(View v){
        ...
        switch ( ( v.getId())){
            case R.id.btnAdd:
                ...
                //подготовим данные для вставки пар: наименование столбца - значение
                ...
                Log.d(LOG_TAG,"row iserted, ID = " + rowID);
                break;
            case R.id.btnRead:
                ...
                if (c.moveToFirst()){
                    ...
                    //определеяем номера столбцов по имени в выборке
